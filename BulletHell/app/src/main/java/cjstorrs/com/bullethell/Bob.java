...
public class Bob {
    ...
    public Bob(Context context, float screenX, float screenY){
        ...
        mRect = new RectF(screenX / 2, screenY / 2,
                (screenX / 2) + mBobWidth, (screenY / 2) + mBobHeight);

        //prepare the bitmap. load bob from his .png file.
    ...
    boolean teleport(float newX, float newY){
        ...
        //move bob tho the new position. if not already teleporting.
        if(!mTeleporting){
